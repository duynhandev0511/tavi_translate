...
# ==============================================================================
MODEL_NAME = "FiveC/tay-to-viet-v4"
...
# vào cache. Model sẽ chỉ được tải lần đầu tiên khi app khởi động, các lần sau sẽ dùng lại
# từ cache, giúp app chạy nhanh hơn rất nhiều.
@st.cache_resource
def load_model():
